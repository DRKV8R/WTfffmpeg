...
def test_without_env_vars():
    ...
    try:
        ...
        with app.app.test_client() as client:
            ...
            assert response.status_code == 503  # Service unavailable due to missing config
            data = response.get_json()
...
def test_with_env_vars():
    ...
    try:
        ...
        with app.app.test_client() as client:
            ...
            assert data['configuration']['cloud_storage_bucket_value'] == 'yt-v8dr-wtfffmpeg-videos'
